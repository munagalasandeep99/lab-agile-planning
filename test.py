...
def setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    def download_file(service: ServiceCall) -> None:
        ...
        threading.Thread(target=do_download, args=(service.data[ATTR_URL], service.data.get(ATTR_SUBDIR), service.data.get(ATTR_FILENAME), service.data.get(ATTR_OVERWRITE))).start()
